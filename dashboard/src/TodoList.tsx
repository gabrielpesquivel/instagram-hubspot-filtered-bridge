...
const styles: Record<string, React.CSSProperties> = {
  ...
  title: { margin: 0, fontSize: "1.25rem", color: "#222" },
  count: { fontSize: "0.85rem", color: "#888", fontWeight: 600 },
  sub: { margin: "0 0 1rem", fontSize: "0.85rem", color: "#888" },
  ...
  text: { fontSize: "0.95rem", color: "#222" },
  textDone: { textDecoration: "line-through", color: "#aaa" },
};
